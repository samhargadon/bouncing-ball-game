...
void setup() {
  size(400, 400);
  myball = new Ball(0, (height/2), random(1, 2), 40, random(255));
}
...
void initScreen() {
  ...
  float textLength1 = (size*15);
  float textLength2 = (size*13);
  ...
  textSize(size);
  fill(0, 255, 255);
  text("Welcome to the bouncing ball game!", line1X, line1Y);
  text("Press the mouse inside the ball!", line2X, line2Y);
  text("+1 point if you get it, -1 if you miss", line3X, line3Y);
